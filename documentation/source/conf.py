...
latex_documents = [
    (master_doc, 'NewsPhi.tex', 'NewsPhi Documentation',
     'NewsPhi', 'manual'),
]
...
man_pages = [
    (master_doc, 'newsphi', 'NewsPhi Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NewsPhi', 'NewsPhi Documentation',
     author, 'NewsPhi', 'One line description of project.',
     'Miscellaneous'),
]
